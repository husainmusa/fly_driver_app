...
var ApiService = /** @class */ (function () {
    function ApiService(http, nativeHttp) {
        ...
        this.orderSub = new rxjs_1.BehaviorSubject([]);
    ...
    ApiService.prototype.getAllOrders = function (url, body) {
        var _this = this;
        var _a;
        var header = {
        ...
        (_a = this.http) === null || _a === void 0 ? void 0 : _a.post(this.baseUrl + url, param, header).subscribe(function (res) {
            _this.orderSub.next(res);
        });
    };
